...
def set_user_menu(main_node=None):
    ...
    user_menu.set_childs([
        ...
        NodeGenerator('Зарегистрироваться на курсы', info='Выберите курс, который Вас заинтересовал. По ссылке Вы сможете пройти записаться на него.', func=show_reg_urls),
